			...
			if (players.index == 2)
	    		{
					ImageIcon CommunityChest1 = new ImageIcon(("CommunityChest1.jpg"));
				    	JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null, JOptionPane.QUESTION_MESSAGE, CommunityChest1);
	    		}
			if (players.index == 3)
		    	{
			...
			if (players.index == 4)
	    		{
					ImageIcon TaxPic = new ImageIcon(("TaxPic.jpg"));
				    	JOptionPane.showMessageDialog(frame, "You have landed on a TAX TILE, time to pay up", null, JOptionPane.QUESTION_MESSAGE, TaxPic);
	    		}
			if (players.index == 5)
	    		{
					ImageIcon HomeOnTheRangeRailroad = new ImageIcon(("HomeOnTheRangeRailroad.gif"));
				    	JOptionPane.showMessageDialog(frame, "You have landed on the HOME ON THE RANGE RAILROAD", null, JOptionPane.QUESTION_MESSAGE, HomeOnTheRangeRailroad);
	    		}
			if (players.index == 6)
		    	{
			...
			if (players.index == 7)
	    		{
	    		 	ImageIcon CommunityChest2 = new ImageIcon(("CommunityChest2.jpg"));
	    		 		JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null, JOptionPane.QUESTION_MESSAGE, CommunityChest2);
	    		}
			if (players.index == 8)
		    	{
			...
			if (players.index == 10)
	    		{
					ImageIcon VisitingPic = new ImageIcon(("VisitingPic.jpg"));
				    	JOptionPane.showMessageDialog(frame, "You have to go to jail for a VISIT", null, JOptionPane.QUESTION_MESSAGE, VisitingPic);
			...
			if (players.index == 15)
	    		{
	    		 	ImageIcon FoxAndTheHoundRailroad = new ImageIcon(("FoxAndTheHoundRailroad.gif"));
	    		 		JOptionPane.showMessageDialog(frame, "You have landed on the FOX AND THE HOUND RAILROAD", null, JOptionPane.QUESTION_MESSAGE, FoxAndTheHoundRailroad);
	    		}
			if (players.index == 16)
		    	{
			...
			if (players.index == 17)
    			{
    		 		ImageIcon CommunityChest3 = new ImageIcon(("CommunityChest3.jpg"));
    		 			JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null, JOptionPane.QUESTION_MESSAGE, CommunityChest3);
    			}
			if (players.index == 18)
		    	{
			...
			if (players.index == 22)
    			{
    		 		ImageIcon CommunityChest4 = new ImageIcon(("CommunityChest4.jpg"));
    		 			JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null, JOptionPane.QUESTION_MESSAGE, CommunityChest4);
    			}
			if (players.index == 23)
		    	{
			...
			if (players.index == 25)
    			{
    		 		ImageIcon AristocatsRailroad = new ImageIcon(("AristocatsRailroad.gif"));
    		 			JOptionPane.showMessageDialog(frame, "You have landed on the ARISTOCATS' RAILRAOD", null, JOptionPane.QUESTION_MESSAGE, AristocatsRailroad);
    			}
			if (players.index == 26)
		    	{
			...
			if (players.index == 30)
	    		{
	    		 	ImageIcon DungeonGif = new ImageIcon(("DungeonGif.gif"));
	    		 		JOptionPane.showMessageDialog(frame, "You have landed in the DUNGEON", null, JOptionPane.QUESTION_MESSAGE, DungeonGif);
			...
			if (players.index == 33)
				{
		 			ImageIcon CommunityChest5 = new ImageIcon(("CommunityChest5.jpg"));
		 				JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null, JOptionPane.QUESTION_MESSAGE, CommunityChest5);
				}
			if (players.index == 34)
		    	{
			...
			if (players.index == 36)
				{
		 			ImageIcon CommunityChest6 = new ImageIcon(("CommunityChest6.jpg"));
		 				JOptionPane.showMessageDialog(frame, "You have landed on a COMMUNITY CHEST TILE", null, JOptionPane.QUESTION_MESSAGE, CommunityChest6);
				}
			if (players.index == 37)
		    	{
			...
			if (players.index == 38)
				{
		 			ImageIcon TaxPic2 = new ImageIcon(("TaxPic2.jpg"));
		 				JOptionPane.showMessageDialog(frame, "You have landed on a TAX TILE, hehe more money to the bank", null, JOptionPane.QUESTION_MESSAGE, TaxPic2);
				}
			if (players.index == 39)
		    	{
